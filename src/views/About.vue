       ...
       <div class="hidden w-full md:flex md:items-center md:w-auto" id="menu">
          ...
          >
            ...
            <li>
              ...
              <!-- <a class="md:p-4 py-2 block hover:text-purple-400" href="#/constituencies"
                >Constituencies</a
              > -->
            </li>
            <li>
        ...
        <div class="mt-6 ">
            <div class="items-center -mx-2 md:flex">
                <div class="w-full mx-2">
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">County name</label>
                    ...
                    focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" type="text">
                </div>

                <div class="w-full mx-2 mt-4 md:mt-0">
                   <label class="block mb-2 text-sm font-medium text-white dark:text-gray-200">County name</label>

                     <button 
                     
                      @click="saveCounty"
                     class="px-4 py-2 text-white transition-colors duration-200 
		...
		<div class="overflow-auto lg:overflow-visible ">
			<table class="table text-gray-400 border-separate space-y-4 text-sm">
				<thead class="bg-gray-100 text-gray-500">
					<tr>
						<th class="p-3">COUNTY NAME</th>
						<th class="p-8 text-left">TOTAL CONSTITUENCIES</th>
				...
				<tbody>
					<tr v-for="county in filteredCounties" v-bind:key="county.id" class="bg-gray-100">
						...
						<td class="p-3 ">
							...
							<a @click="deleteCounty(county.id)" class="text-red-600 hover:text-red-900  ml-2">
...
export default {
  ...
  methods:{
    ...
    saveCounty(){
      ...
      return axios.post('https://techwithnick.com/locations/counties/',data)
        .then(response => {
    ...
    deleteCounty(id){
      return axios.delete(`https://techwithnick.com/locations/counties/${id}/`)
        .then(response => {
          console.log(response.data);
          this.getCounties()
        })
